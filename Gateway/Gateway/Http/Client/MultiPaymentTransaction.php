...
class MultiPaymentTransaction implements ClientInterface
{
    /**
     * @var PaymentPageApi
     */
    ...
    {
        try {
            return $this->paymentPageApi->getMultiPaymentApi($transferObject->getBody());
        } catch (Exception $exception) {
            throw new CouldNotSaveException(
                __('Error While Placing Order.')
            );
        }
    }
}
